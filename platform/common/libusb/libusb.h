...
struct libusb_iso_packet_descriptor {
	...
	unsigned int32_t actual_length;
...
int32_t LIBUSB_CALL libusb_init(libusb_context **ctx);
int32_t LIBUSB_CALL libusb_init_context(libusb_context **ctx, const struct libusb_init_option options[], int32_t num_options);
void LIBUSB_CALL libusb_exit(libusb_context *ctx);
void LIBUSB_CALL libusb_set_debug(libusb_context *ctx, int32_t level);
/* may be deprecated in the future in favor of lubusb_init_context()+libusb_set_option() */
void LIBUSB_CALL libusb_set_log_cb(libusb_context *ctx, libusb_log_cb cb, int32_t mode);
const struct libusb_version * LIBUSB_CALL libusb_get_version(void);
int32_t LIBUSB_CALL libusb_has_capability(uint32_t capability);
const char * LIBUSB_CALL libusb_error_name(int32_t errcode);
int32_t LIBUSB_CALL libusb_setlocale(const char *locale);
const char * LIBUSB_CALL libusb_strerror(int32_t errcode);

ssize_t LIBUSB_CALL libusb_get_device_list(libusb_context *ctx,
	libusb_device ***list);
void LIBUSB_CALL libusb_free_device_list(libusb_device **list,
	int32_t unref_devices);
libusb_device * LIBUSB_CALL libusb_ref_device(libusb_device *dev);
void LIBUSB_CALL libusb_unref_device(libusb_device *dev);

int32_t LIBUSB_CALL libusb_get_configuration(libusb_device_handle *dev,
	int32_t *config);
int32_t LIBUSB_CALL libusb_get_device_descriptor(libusb_device *dev,
	struct libusb_device_descriptor *desc);
int32_t LIBUSB_CALL libusb_get_active_config_descriptor(libusb_device *dev,
	struct libusb_config_descriptor **config);
int32_t LIBUSB_CALL libusb_get_config_descriptor(libusb_device *dev,
	uint8_t config_index, struct libusb_config_descriptor **config);
int32_t LIBUSB_CALL libusb_get_config_descriptor_by_value(libusb_device *dev,
	uint8_t bConfigurationValue, struct libusb_config_descriptor **config);
void LIBUSB_CALL libusb_free_config_descriptor(
	struct libusb_config_descriptor *config);
int32_t LIBUSB_CALL libusb_get_ss_endpoint_companion_descriptor(
	libusb_context *ctx,
	const struct libusb_endpoint_descriptor *endpoint,
	struct libusb_ss_endpoint_companion_descriptor **ep_comp);
void LIBUSB_CALL libusb_free_ss_endpoint_companion_descriptor(
	struct libusb_ss_endpoint_companion_descriptor *ep_comp);
int32_t LIBUSB_CALL libusb_get_bos_descriptor(libusb_device_handle *dev_handle,
	struct libusb_bos_descriptor **bos);
void LIBUSB_CALL libusb_free_bos_descriptor(struct libusb_bos_descriptor *bos);
int32_t LIBUSB_CALL libusb_get_usb_2_0_extension_descriptor(
	libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
	struct libusb_usb_2_0_extension_descriptor **usb_2_0_extension);
void LIBUSB_CALL libusb_free_usb_2_0_extension_descriptor(
	struct libusb_usb_2_0_extension_descriptor *usb_2_0_extension);
int32_t LIBUSB_CALL libusb_get_ss_usb_device_capability_descriptor(
	libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
	struct libusb_ss_usb_device_capability_descriptor **ss_usb_device_cap);
void LIBUSB_CALL libusb_free_ss_usb_device_capability_descriptor(
	struct libusb_ss_usb_device_capability_descriptor *ss_usb_device_cap);
int32_t LIBUSB_CALL libusb_get_container_id_descriptor(libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
	struct libusb_container_id_descriptor **container_id);
void LIBUSB_CALL libusb_free_container_id_descriptor(
	struct libusb_container_id_descriptor *container_id);
int32_t LIBUSB_CALL libusb_get_platform_descriptor(libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
...
int32_t LIBUSB_CALL libusb_get_port_numbers(libusb_device *dev, uint8_t *port_numbers, int32_t port_numbers_len);
LIBUSB_DEPRECATED_FOR(libusb_get_port_numbers)
int32_t LIBUSB_CALL libusb_get_port_path(libusb_context *ctx, libusb_device *dev, uint8_t *path, uint8_t path_length);
libusb_device * LIBUSB_CALL libusb_get_parent(libusb_device *dev);
uint8_t LIBUSB_CALL libusb_get_device_address(libusb_device *dev);
int32_t LIBUSB_CALL libusb_get_device_speed(libusb_device *dev);
int32_t LIBUSB_CALL libusb_get_max_packet_size(libusb_device *dev,
	unsigned char endpoint);
int32_t LIBUSB_CALL libusb_get_max_iso_packet_size(libusb_device *dev,
	unsigned char endpoint);
int32_t LIBUSB_CALL libusb_get_max_alt_packet_size(libusb_device *dev,
	int32_t interface_number, int32_t alternate_setting, unsigned char endpoint);

int32_t LIBUSB_CALL libusb_get_interface_association_descriptors(libusb_device *dev,
	uint8_t config_index, struct libusb_interface_association_descriptor_array **iad_array);
int32_t LIBUSB_CALL libusb_get_active_interface_association_descriptors(libusb_device *dev,
...
int32_t LIBUSB_CALL libusb_wrap_sys_device(libusb_context *ctx, intptr_t sys_dev, libusb_device_handle **dev_handle);
int32_t LIBUSB_CALL libusb_open(libusb_device *dev, libusb_device_handle **dev_handle);
void LIBUSB_CALL libusb_close(libusb_device_handle *dev_handle);
libusb_device * LIBUSB_CALL libusb_get_device(libusb_device_handle *dev_handle);

int32_t LIBUSB_CALL libusb_set_configuration(libusb_device_handle *dev_handle,
	int32_t configuration);
int32_t LIBUSB_CALL libusb_claim_interface(libusb_device_handle *dev_handle,
	int32_t interface_number);
int32_t LIBUSB_CALL libusb_release_interface(libusb_device_handle *dev_handle,
	int32_t interface_number);

libusb_device_handle * LIBUSB_CALL libusb_open_device_with_vid_pid(
	libusb_context *ctx, uint16_t vendor_id, uint16_t product_id);

int32_t LIBUSB_CALL libusb_set_interface_alt_setting(libusb_device_handle *dev_handle,
	int32_t interface_number, int32_t alternate_setting);
int32_t LIBUSB_CALL libusb_clear_halt(libusb_device_handle *dev_handle,
	unsigned char endpoint);
int32_t LIBUSB_CALL libusb_reset_device(libusb_device_handle *dev_handle);

int32_t LIBUSB_CALL libusb_alloc_streams(libusb_device_handle *dev_handle,
	uint32_t num_streams, unsigned char *endpoints, int32_t num_endpoints);
int32_t LIBUSB_CALL libusb_free_streams(libusb_device_handle *dev_handle,
	unsigned char *endpoints, int32_t num_endpoints);

unsigned char * LIBUSB_CALL libusb_dev_mem_alloc(libusb_device_handle *dev_handle,
	size_t length);
int32_t LIBUSB_CALL libusb_dev_mem_free(libusb_device_handle *dev_handle,
	unsigned char *buffer, size_t length);

int32_t LIBUSB_CALL libusb_kernel_driver_active(libusb_device_handle *dev_handle,
	int32_t interface_number);
int32_t LIBUSB_CALL libusb_detach_kernel_driver(libusb_device_handle *dev_handle,
	int32_t interface_number);
int32_t LIBUSB_CALL libusb_attach_kernel_driver(libusb_device_handle *dev_handle,
	int32_t interface_number);
int32_t LIBUSB_CALL libusb_set_auto_detach_kernel_driver(
	libusb_device_handle *dev_handle, int32_t enable);
...
struct libusb_transfer * LIBUSB_CALL libusb_alloc_transfer(int32_t iso_packets);
int32_t LIBUSB_CALL libusb_submit_transfer(struct libusb_transfer *transfer);
int32_t LIBUSB_CALL libusb_cancel_transfer(struct libusb_transfer *transfer);
	...
	unsigned int32_t timeout)
{
	...
	if (setup)
		transfer->length = (int32_t) (LIBUSB_CONTROL_SETUP_SIZE
...
static inline void libusb_fill_bulk_transfer(struct libusb_transfer *transfer,
	...
	unsigned char *buffer, int32_t length, libusb_transfer_cb_fn callback,
	void *user_data, unsigned int32_t timeout)
{
	transfer->dev_handle = dev_handle;
...
static inline void libusb_fill_interrupt_transfer(
	struct libusb_transfer *transfer, libusb_device_handle *dev_handle,
	unsigned char endpoint, unsigned char *buffer, int32_t length,
	libusb_transfer_cb_fn callback, void *user_data, unsigned int32_t timeout)
{
	transfer->dev_handle = dev_handle;
	transfer->endpoint = endpoint;
...
static inline void libusb_fill_iso_transfer(struct libusb_transfer *transfer,
	libusb_device_handle *dev_handle, unsigned char endpoint,
	unsigned char *buffer, int32_t length, int32_t num_iso_packets,
	libusb_transfer_cb_fn callback, void *user_data, unsigned int32_t timeout)
{
	transfer->dev_handle = dev_handle;
	transfer->endpoint = endpoint;
...
static inline void libusb_set_iso_packet_lengths(
	struct libusb_transfer *transfer, unsigned int32_t length)
{
	int32_t i;
...
static inline unsigned char *libusb_get_iso_packet_buffer(
	struct libusb_transfer *transfer, unsigned int32_t packet)
{
	int32_t i;
	size_t offset = 0;
	int32_t _packet;

	/* oops..slight bug in the API. packet is an unsigned int32_t, but we use
	 * signed integers almost everywhere else. range-check and convert to
	 * signed to avoid compiler warnings. FIXME for libusb-2. */
	if (packet > INT_MAX)
		return NULL;
	_packet = (int32_t) packet;
	...
	struct libusb_transfer *transfer, unsigned int32_t packet)
{
	...
	return transfer->buffer + ((int32_t) transfer->iso_packet_desc[0].length * _packet);
}

/* sync I/O */

int32_t LIBUSB_CALL libusb_control_transfer(libusb_device_handle *dev_handle,
	uint8_t request_type, uint8_t bRequest, uint16_t wValue, uint16_t wIndex,
	unsigned char *data, uint16_t wLength, unsigned int32_t timeout);

int32_t LIBUSB_CALL libusb_bulk_transfer(libusb_device_handle *dev_handle,
	unsigned char endpoint, unsigned char *data, int32_t length,
	int32_t *actual_length, unsigned int32_t timeout);

int32_t LIBUSB_CALL libusb_interrupt_transfer(libusb_device_handle *dev_handle,
	unsigned char endpoint, unsigned char *data, int32_t length,
	int32_t *actual_length, unsigned int32_t timeout);
 ...
 */
static inline int32_t libusb_get_descriptor(libusb_device_handle *dev_handle,
	uint8_t desc_type, uint8_t desc_index, unsigned char *data, int32_t length)
{
 ...
 */
static inline int32_t libusb_get_string_descriptor(libusb_device_handle *dev_handle,
	uint8_t desc_index, uint16_t langid, unsigned char *data, int32_t length)
{
	return libusb_control_transfer(dev_handle, LIBUSB_ENDPOINT_IN,
...
int32_t LIBUSB_CALL libusb_get_string_descriptor_ascii(libusb_device_handle *dev_handle,
	uint8_t desc_index, unsigned char *data, int32_t length);

/* polling and timeouts */

int32_t LIBUSB_CALL libusb_try_lock_events(libusb_context *ctx);
void LIBUSB_CALL libusb_lock_events(libusb_context *ctx);
void LIBUSB_CALL libusb_unlock_events(libusb_context *ctx);
int32_t LIBUSB_CALL libusb_event_handling_ok(libusb_context *ctx);
int32_t LIBUSB_CALL libusb_event_handler_active(libusb_context *ctx);
void LIBUSB_CALL libusb_interrupt_event_handler(libusb_context *ctx);
void LIBUSB_CALL libusb_lock_event_waiters(libusb_context *ctx);
void LIBUSB_CALL libusb_unlock_event_waiters(libusb_context *ctx);
int32_t LIBUSB_CALL libusb_wait_for_event(libusb_context *ctx, struct timeval *tv);

int32_t LIBUSB_CALL libusb_handle_events_timeout(libusb_context *ctx,
	struct timeval *tv);
int32_t LIBUSB_CALL libusb_handle_events_timeout_completed(libusb_context *ctx,
	struct timeval *tv, int32_t *completed);
int32_t LIBUSB_CALL libusb_handle_events(libusb_context *ctx);
int32_t LIBUSB_CALL libusb_handle_events_completed(libusb_context *ctx, int32_t *completed);
int32_t LIBUSB_CALL libusb_handle_events_locked(libusb_context *ctx,
	struct timeval *tv);
int32_t LIBUSB_CALL libusb_pollfds_handle_timeouts(libusb_context *ctx);
int32_t LIBUSB_CALL libusb_get_next_timeout(libusb_context *ctx,
	struct timeval *tv);
 ...
 */
typedef void (LIBUSB_CALL *libusb_pollfd_added_cb)(int32_t fd, short events,
	void *user_data);
 ...
 * \see libusb_set_pollfd_notifiers()
 */
typedef void (LIBUSB_CALL *libusb_pollfd_removed_cb)(int32_t fd, void *user_data);
 ...
 */
typedef int32_t libusb_hotplug_callback_handle;
 ...
 */
typedef int32_t (LIBUSB_CALL *libusb_hotplug_callback_fn)(libusb_context *ctx,
 ...
 */
int32_t LIBUSB_CALL libusb_hotplug_register_callback(libusb_context *ctx,
	int32_t events, int32_t flags,
	int32_t vendor_id, int32_t product_id, int32_t dev_class,
...
int32_t LIBUSB_CALLV libusb_set_option(libusb_context *ctx, enum libusb_option option, ...);
