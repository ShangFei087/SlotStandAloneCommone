...
struct windows_usb_api_backend {
	...
	void (*exit)(void);
	int32_t (*open)(int32_t sub_api, struct libusb_device_handle *dev_handle);
	void (*close)(int32_t sub_api, struct libusb_device_handle *dev_handle);
	int32_t (*configure_endpoints)(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
	int32_t (*claim_interface)(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
	int32_t (*set_interface_altsetting)(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface, uint8_t altsetting);
	int32_t (*release_interface)(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
	int32_t (*clear_halt)(int32_t sub_api, struct libusb_device_handle *dev_handle, unsigned char endpoint);
	int32_t (*reset_device)(int32_t sub_api, struct libusb_device_handle *dev_handle);
	int32_t (*submit_bulk_transfer)(int32_t sub_api, struct usbi_transfer *itransfer);
	int32_t (*submit_iso_transfer)(int32_t sub_api, struct usbi_transfer *itransfer);
	int32_t (*submit_control_transfer)(int32_t sub_api, struct usbi_transfer *itransfer);
	int32_t (*cancel_transfer)(int32_t sub_api, struct usbi_transfer *itransfer);
	enum libusb_transfer_status (*copy_transfer_data)(int32_t sub_api, struct usbi_transfer *itransfer, DWORD length);
};
...
#pragma warning(push)
#pragma warning(disable:4214)  // bit field types other than int32_t
#endif
