...
static int32_t winusbx_open(int32_t sub_api, struct libusb_device_handle *dev_handle);
static void winusbx_close(int32_t sub_api, struct libusb_device_handle *dev_handle);
static int32_t winusbx_configure_endpoints(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t winusbx_claim_interface(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t winusbx_release_interface(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t winusbx_submit_control_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t winusbx_set_interface_altsetting(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface, uint8_t altsetting);
static int32_t winusbx_submit_iso_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t winusbx_submit_bulk_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t winusbx_clear_halt(int32_t sub_api, struct libusb_device_handle *dev_handle, unsigned char endpoint);
static int32_t winusbx_cancel_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t winusbx_reset_device(int32_t sub_api, struct libusb_device_handle *dev_handle);
static enum libusb_transfer_status winusbx_copy_transfer_data(int32_t sub_api, struct usbi_transfer *itransfer, DWORD length);
// HID API prototypes
static bool hid_init(struct libusb_context *ctx);
static void hid_exit(void);
static int32_t hid_open(int32_t sub_api, struct libusb_device_handle *dev_handle);
static void hid_close(int32_t sub_api, struct libusb_device_handle *dev_handle);
static int32_t hid_claim_interface(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t hid_release_interface(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t hid_set_interface_altsetting(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface, uint8_t altsetting);
static int32_t hid_submit_control_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t hid_submit_bulk_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t hid_clear_halt(int32_t sub_api, struct libusb_device_handle *dev_handle, unsigned char endpoint);
static int32_t hid_reset_device(int32_t sub_api, struct libusb_device_handle *dev_handle);
static enum libusb_transfer_status hid_copy_transfer_data(int32_t sub_api, struct usbi_transfer *itransfer, DWORD length);
// Composite API prototypes
static int32_t composite_open(int32_t sub_api, struct libusb_device_handle *dev_handle);
static void composite_close(int32_t sub_api, struct libusb_device_handle *dev_handle);
static int32_t composite_claim_interface(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t composite_set_interface_altsetting(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface, uint8_t altsetting);
static int32_t composite_release_interface(int32_t sub_api, struct libusb_device_handle *dev_handle, uint8_t iface);
static int32_t composite_submit_control_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t composite_submit_bulk_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t composite_submit_iso_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t composite_clear_halt(int32_t sub_api, struct libusb_device_handle *dev_handle, unsigned char endpoint);
static int32_t composite_cancel_transfer(int32_t sub_api, struct usbi_transfer *itransfer);
static int32_t composite_reset_device(int32_t sub_api, struct libusb_device_handle *dev_handle);
static enum libusb_transfer_status composite_copy_transfer_data(int32_t sub_api, struct usbi_transfer *itransfer, DWORD length);
...
static const char *guid_to_string(const GUID *guid, char guid_string[MAX_GUID_STRING_LENGTH])
{
	...
	sprintf(guid_string, "{%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X}",
		(unsigned int32_t)guid->Data1, guid->Data2, guid->Data3,
 ...
 * incremented index starting at zero) until all interfaces have been returned.
 */
static int32_t get_interface_details(struct libusb_context *ctx, HDEVINFO dev_info,
...
/* For libusb0 filter */
static int32_t get_interface_details_filter(struct libusb_context *ctx, HDEVINFO *dev_info,
	DWORD _index, char *filter_path, char **dev_interface_path)
{
	...
	DWORD size;
	int32_t err = LIBUSB_ERROR_OTHER;
	...
	if (hkey_dev_interface != INVALID_HANDLE_VALUE) {
		...
		if (status == ERROR_SUCCESS) {
			if (libusb0_symboliclink_index < 256) {
				...
				sprintf(filter_path, "\\\\.\\libusb0-%04u", (unsigned int32_t)libusb0_symboliclink_index);
 ...
 */
static int32_t get_interface_by_endpoint(struct libusb_config_descriptor *conf_desc, uint8_t ep)
{
...
static const struct libusb_interface_descriptor *get_interface_descriptor_by_number(struct libusb_device_handle *dev_handle, struct libusb_config_descriptor *conf_desc, int32_t iface, uint8_t altsetting)
{
	int32_t i;
	...
	usbi_err(HANDLE_CTX(dev_handle), "interface %d with altsetting %d not found for device", iface, (int32_t)altsetting);
	return NULL;
}
 ...
 */
static int32_t windows_assign_endpoints(struct libusb_device_handle *dev_handle, uint8_t iface, uint8_t altsetting)
{
...
static int32_t get_sub_api(char *driver, int32_t api)
{
 ...
 */
static int32_t auto_claim(struct libusb_transfer *transfer, int32_t *interface_number, int32_t api_type)
{
	...
	int32_t current_interface = *interface_number;
	int32_t r = LIBUSB_SUCCESS;
 ...
 */
static int32_t winusb_init(struct libusb_context *ctx)
{
	int32_t i;
...
static int32_t alloc_root_hub_config_desc(struct libusb_device *dev, ULONG num_ports,
...
static int32_t init_root_hub(struct libusb_device *dev)
{
	struct libusb_context *ctx = DEVICE_CTX(dev);
	struct winusb_device_priv *priv = usbi_get_device_priv(dev);
 ...
 */
static int32_t init_device(struct libusb_device *dev, struct libusb_device *parent_dev,
...
static int32_t enumerate_hcd_root_hub(struct libusb_context *ctx, const char *dev_id,
	DEVINST devinst)
{
...
static int32_t set_composite_interface(struct libusb_context *ctx, struct libusb_device *dev,
	char *dev_interface_path, char *device_id, int32_t api, int32_t sub_api)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev);
	int32_t interface_number;
	const char *mi_str;
	int32_t iadi, iadintfi;
	char* endptr;
...
static int32_t set_hid_interface(struct libusb_context *ctx, struct libusb_device *dev,
...
static int32_t get_guid(struct libusb_context *ctx, char *dev_id, HDEVINFO *dev_info, SP_DEVINFO_DATA *dev_info_data,
					int32_t guid_number, GUID **if_guid)
{
	DWORD size, reg_type;
	HKEY key;
	...
	char *guid, *guid_term;
	LONG s;
	int32_t pass, guids_left;
	int32_t err = LIBUSB_SUCCESS;
#if !defined(ENABLE_LOGGING)
	UNUSED(dev_id);
#endif
 ...
 */
static int32_t winusb_get_device_list(struct libusb_context *ctx, struct discovered_devs **_discdevs)
{
	...
	int32_t r = LIBUSB_SUCCESS;
	int32_t api, sub_api;
	unsigned int32_t pass, pass_type, i, j;
	char enumerator[16];
...
#define GUID_SIZE_STEP 8
	...
	unsigned int32_t guid_size = GUID_SIZE_STEP;
	unsigned int32_t nb_guids;
	// Keep a list of PnP enumerator strings that are found
	const char *usb_enumerator[8] = { "USB" };
	unsigned int32_t nb_usb_enumerators = 1;
	unsigned int32_t usb_enum_index = 0;
	// Keep a list of newly allocated devs to unref
#define UNREF_SIZE_STEP 16
	libusb_device **unref_list, **new_unref_list;
	unsigned int32_t unref_size = UNREF_SIZE_STEP;
	unsigned int32_t unref_cur = 0;
	DWORD hub_port_nr;
...
static int32_t winusb_get_config_descriptor(struct libusb_device *dev, uint8_t config_index, void *buffer, size_t len)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev);
...
static int32_t winusb_get_config_descriptor_by_value(struct libusb_device *dev, uint8_t bConfigurationValue,
	void **buffer)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev);
	PUSB_CONFIGURATION_DESCRIPTOR config_header;
	...
	for (index = 0; index < dev->device_descriptor.bNumConfigurations; index++) {
		...
		if (config_header->bConfigurationValue == bConfigurationValue) {
			*buffer = config_header;
			return (int32_t)config_header->wTotalLength;
		}
	}
 ...
 */
static int32_t winusb_get_active_config_descriptor(struct libusb_device *dev, void *buffer, size_t len)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev);
	void *config_desc;
	int32_t r;
...
static int32_t winusb_open(struct libusb_device_handle *dev_handle)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
...
static int32_t winusb_get_configuration(struct libusb_device_handle *dev_handle, uint8_t *config)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
 ...
 * the configuration."
 */
static int32_t winusb_set_configuration(struct libusb_device_handle *dev_handle, uint8_t config)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
	int32_t r = LIBUSB_SUCCESS;
...
static int32_t winusb_claim_interface(struct libusb_device_handle *dev_handle, uint8_t iface)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
	int32_t r;
...
static int32_t winusb_set_interface_altsetting(struct libusb_device_handle *dev_handle, uint8_t iface, uint8_t altsetting)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
	int32_t r;
...
static int32_t winusb_release_interface(struct libusb_device_handle *dev_handle, uint8_t iface)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
...
static int32_t winusb_clear_halt(struct libusb_device_handle *dev_handle, unsigned char endpoint)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
...
static int32_t winusb_reset_device(struct libusb_device_handle *dev_handle)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
...
static int32_t winusb_submit_transfer(struct usbi_transfer *itransfer)
{
	struct libusb_transfer *transfer = USBI_TRANSFER_TO_LIBUSB_TRANSFER(itransfer);
	struct winusb_device_priv *priv = usbi_get_device_priv(transfer->dev_handle->dev);
	int32_t (*transfer_fn)(int32_t, struct usbi_transfer *);
...
static int32_t winusb_cancel_transfer(struct usbi_transfer *itransfer)
{
	struct libusb_transfer *transfer = USBI_TRANSFER_TO_LIBUSB_TRANSFER(itransfer);
	struct winusb_device_priv *priv = usbi_get_device_priv(transfer->dev_handle->dev);
 ...
 */
static int32_t get_valid_interface(struct libusb_device_handle *dev_handle, int32_t api_id)
{
	struct winusb_device_handle_priv *handle_priv = get_winusb_device_handle_priv(dev_handle);
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
	int32_t i;
...
*/
static int32_t check_valid_interface(struct libusb_device_handle *dev_handle, unsigned short interface, int32_t api_id)
{
	struct winusb_device_handle_priv *handle_priv = get_winusb_device_handle_priv(dev_handle);
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
 ...
 */
static int32_t interface_by_endpoint(struct winusb_device_priv *priv,
...
static int32_t winusbx_submit_iso_transfer(int32_t sub_api, struct usbi_transfer *itransfer)
{
	...
	if ((sub_api == SUB_API_LIBUSBK) || (sub_api == SUB_API_LIBUSB0)) {
		...
		if (IS_XFERIN(transfer)) {
			int32_t interval = pipe_info_ex.Interval;
...
static int32_t winusbx_cancel_transfer(int32_t sub_api, struct usbi_transfer *itransfer)
{
	...
	struct winusb_transfer_priv *transfer_priv = get_winusb_transfer_priv(itransfer);
	struct winusb_device_priv *priv = usbi_get_device_priv(transfer->dev_handle->dev);
	int32_t current_interface = transfer_priv->interface_number;
	HANDLE handle;
...
static enum libusb_transfer_status winusbx_copy_transfer_data(int32_t sub_api, struct usbi_transfer *itransfer, DWORD length)
{
	...
	if (transfer->type == LIBUSB_TRANSFER_TYPE_ISOCHRONOUS) {
		...
		if ((sub_api == SUB_API_LIBUSBK) || (sub_api == SUB_API_LIBUSB0)) {
			...
			if (IS_XFERIN(transfer)) {
				...
				for (i = 0; i < transfer->num_iso_packets; i++) {
					unsigned int32_t packet_length = (i < transfer->num_iso_packets - 1) ? (usbd_iso_packet_desc[i + 1].Offset - usbd_iso_packet_desc[i].Offset) : usbd_iso_packet_desc[i].Length;
					unsigned int32_t actual_length = usbd_iso_packet_desc[i].Length;
	...
	itransfer->transferred += (int32_t)length;
 ...
 */
static int32_t _hid_get_hid_descriptor(struct hid_device_priv *dev, void *data, size_t *size);
static int32_t _hid_get_report_descriptor(struct hid_device_priv *dev, void *data, size_t *size);

static int32_t _hid_wcslen(WCHAR *str)
{
	int32_t i = 0;
...
static int32_t _hid_get_device_descriptor(struct hid_device_priv *hid_priv, void *data, size_t *size)
{
...
static int32_t _hid_get_config_descriptor(struct hid_device_priv *hid_priv, void *data, size_t *size)
{
...
static int32_t _hid_get_string_descriptor(struct hid_device_priv *hid_priv, int32_t _index,
...
static int32_t _hid_get_hid_descriptor(struct hid_device_priv *hid_priv, void *data, size_t *size)
{
...
static int32_t _hid_get_report_descriptor(struct hid_device_priv *hid_priv, void *data, size_t *size)
{
...
static int32_t _hid_get_descriptor(struct libusb_device *dev, HANDLE hid_handle, int32_t recipient,
	int32_t type, int32_t _index, void *data, size_t *size)
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev);
	UNUSED(recipient);
...
static int32_t _hid_get_report(struct libusb_device *dev, HANDLE hid_handle, int32_t id, void *data,
	struct winusb_transfer_priv *tp, size_t size, OVERLAPPED *overlapped, int32_t report_type)
{
...
static int32_t _hid_set_report(struct libusb_device *dev, HANDLE hid_handle, int32_t id, void *data,
	struct winusb_transfer_priv *tp, size_t size, OVERLAPPED *overlapped, int32_t report_type)
{
...
static int32_t _hid_class_request(struct libusb_device *dev, HANDLE hid_handle, int32_t request_type,
	int32_t request, int32_t value, int32_t _index, void *data, struct winusb_transfer_priv *tp,
	size_t size, OVERLAPPED *overlapped)
{
	int32_t report_type = (value >> 8) & 0xFF;
	int32_t report_id = value & 0xFF;
...
static int32_t hid_open(int32_t sub_api, struct libusb_device_handle *dev_handle)
{
	...
	// report IDs handling
	ULONG size[3];
	int32_t nb_ids[2]; // zero and nonzero report IDs
#if defined(ENABLE_LOGGING)
...
static int32_t hid_submit_bulk_transfer(int32_t sub_api, struct usbi_transfer *itransfer)
{
	...
	bool direction_in;
	BOOL ret;
	int32_t current_interface, length;
...
{
	struct winusb_device_priv *priv = usbi_get_device_priv(dev_handle->dev);
	int32_t i, r = LIBUSB_ERROR_NOT_FOUND;
