...
static inline int32_t usbi_mutex_trylock(usbi_mutex_t *mutex)
{
...
int32_t usbi_cond_timedwait(usbi_cond_t *cond,
...
static inline unsigned int32_t usbi_get_tid(void)
{
	return (unsigned int32_t)GetCurrentThreadId();
}
