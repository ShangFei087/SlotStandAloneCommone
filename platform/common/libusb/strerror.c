...
int32_t API_EXPORTED libusb_setlocale(const char *locale)
{
	size_t i;
 ...
 */
DEFAULT_VISIBILITY const char * LIBUSB_CALL libusb_strerror(int32_t errcode)
{
	int32_t errcode_index = -errcode;
