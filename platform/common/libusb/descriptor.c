...
static int32_t parse_endpoint(struct libusb_context *ctx,
	struct libusb_endpoint_descriptor *endpoint, const uint8_t *buffer, int32_t size)
{
...
static int32_t parse_interface(libusb_context *ctx,
	struct libusb_interface *usb_interface, const uint8_t *buffer, int32_t size)
{
	int32_t len;
	int32_t r;
	int32_t parsed = 0;
...
static int32_t parse_configuration(struct libusb_context *ctx,
	struct libusb_config_descriptor *config, const uint8_t *buffer, int32_t size)
{
	uint8_t i;
	int32_t r;
	const struct usbi_descriptor_header *header;
...
static int32_t raw_desc_to_config(struct libusb_context *ctx,
	const uint8_t *buf, int32_t size, struct libusb_config_descriptor **config)
{
...
static int32_t get_active_config_descriptor(struct libusb_device *dev,
	uint8_t *buffer, size_t size)
{
	int32_t r = usbi_backend.get_active_config_descriptor(dev, buffer, size);
...
static int32_t get_config_descriptor(struct libusb_device *dev, uint8_t config_idx,
	uint8_t *buffer, size_t size)
{
	int32_t r = usbi_backend.get_config_descriptor(dev, config_idx, buffer, size);
 ...
 */
int32_t API_EXPORTED libusb_get_device_descriptor(libusb_device *dev,
 ...
 */
int32_t API_EXPORTED libusb_get_active_config_descriptor(libusb_device *dev,
 ...
 */
int32_t API_EXPORTED libusb_get_config_descriptor(libusb_device *dev,
 ...
 * \see libusb_get_config_descriptor()
 */
int32_t API_EXPORTED libusb_get_config_descriptor_by_value(libusb_device *dev,
 ...
 * \returns another LIBUSB_ERROR code on error
 */
int32_t API_EXPORTED libusb_get_ss_endpoint_companion_descriptor(
	libusb_context *ctx,
	...
	struct libusb_ss_endpoint_companion_descriptor **ep_comp)
{
	...
	int32_t size = endpoint->extra_length;
...
static int32_t parse_bos(struct libusb_context *ctx,
 ...
 * \returns another LIBUSB_ERROR code on error
 */
int32_t API_EXPORTED libusb_get_bos_descriptor(libusb_device_handle *dev_handle,
	struct libusb_bos_descriptor **bos)
{
 ...
 */
int32_t API_EXPORTED libusb_get_usb_2_0_extension_descriptor(
	libusb_context *ctx,
 ...
 * \returns a LIBUSB_ERROR code on error
 */
int32_t API_EXPORTED libusb_get_ss_usb_device_capability_descriptor(
	libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
 ...
 * \returns a LIBUSB_ERROR code on error
 */
int32_t API_EXPORTED libusb_get_container_id_descriptor(libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
 ...
 * \returns a LIBUSB_ERROR code on error
 */
int32_t API_EXPORTED libusb_get_platform_descriptor(libusb_context *ctx,
	struct libusb_bos_dev_capability_descriptor *dev_cap,
 ...
 */
int32_t API_EXPORTED libusb_get_string_descriptor_ascii(libusb_device_handle *dev_handle,
...
static int32_t parse_iad_array(struct libusb_context *ctx,
...
static int32_t raw_desc_to_iad_array(struct libusb_context *ctx, const uint8_t *buf,
		int32_t size, struct libusb_interface_association_descriptor_array **iad_array)
{
 ...
 */
int32_t API_EXPORTED libusb_get_interface_association_descriptors(libusb_device *dev,
 ...
 */
int32_t API_EXPORTED libusb_get_active_interface_association_descriptors(libusb_device *dev,
	struct libusb_interface_association_descriptor_array **iad_array)
{
	union usbi_config_desc_buf _config;
	uint16_t config_len;
