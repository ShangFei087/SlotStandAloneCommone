 ...
 *
 * A callback function must return an int32_t (0 or 1) indicating whether the callback is
...
int32_t hotplug_callback(struct libusb_context *ctx, struct libusb_device *dev,
...
static int32_t usbi_hotplug_match_cb(struct libusb_device *dev,
...
int32_t API_EXPORTED libusb_hotplug_register_callback(libusb_context *ctx,
