...
{
	int32_t r, *completed = transfer->user_data;
 ...
 */
int32_t API_EXPORTED libusb_control_transfer(libusb_device_handle *dev_handle,
...
static int32_t do_sync_bulk_transfer(struct libusb_device_handle *dev_handle,
	unsigned char endpoint, unsigned char *buffer, int32_t length,
	int32_t *transferred, unsigned int32_t timeout, unsigned char type)
{
	struct libusb_transfer *transfer;
	int32_t completed = 0;
	int32_t r;
 ...
 * \returns another LIBUSB_ERROR code on other failures
 */
int32_t API_EXPORTED libusb_bulk_transfer(libusb_device_handle *dev_handle,
	unsigned char endpoint, unsigned char *data, int32_t length,
	int32_t *transferred, unsigned int32_t timeout)
{
 ...
 */
int32_t API_EXPORTED libusb_interrupt_transfer(libusb_device_handle *dev_handle,
	unsigned char endpoint, unsigned char *data, int32_t length,
	int32_t *transferred, unsigned int32_t timeout)
{
	return do_sync_bulk_transfer(dev_handle, endpoint, data, length,
